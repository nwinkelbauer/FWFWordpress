...
class UW_Widget_Conditions
{
  ...
  {
    wp_enqueue_style( 'widget-conditions', get_stylesheet_directory_uri() .  '/setup/css/widget-conditions.css' );
    wp_enqueue_script( 'widget-conditions', get_stylesheet_directory_uri() . '/setup/js/widget-conditions.js' , array( 'jquery', 'jquery-ui-core' ), true);
